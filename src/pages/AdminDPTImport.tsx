...
const AdminDPTImport = (): JSX.Element => {
  ...
  const [mappedColumns] = useState(['NIM/NIDN/NIP', 'Nama Lengkap', 'Fakultas', 'Program Studi', 'Angkatan', 'Status', 'Email'])
  ...
  const handleImport = () => {
    showToast('Impor berhasil (simulasi).', 'success')
    resetImport()
    navigate('/admin/dpt')
  }
      ...
      <div className="admin-dpt-page">
        ...
        {importStep === 3 && (
          <section className="card">
            ...
            <button className="btn-link" type="button" onClick={() => showToast('Detail error', 'info')}>
              Lihat Detail
            </button>
            <div className="form-actions">
              <button className="btn-outline" type="button" onClick={goBack}>
        ...
        {importStep === 4 && (
          <section className="card">
            ...
            <div className="form-actions">
              <button className="btn-outline" type="button" onClick={() => showToast('Download log error', 'info')}>
                Download Log Error
              </button>
